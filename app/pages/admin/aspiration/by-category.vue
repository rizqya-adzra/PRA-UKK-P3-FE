...
useHead({
  title: 'Aspirasi Berdasarkan Kategori | Aspiration',
  meta: [
...
<template>
  <div class="py-6 md:py-0 min-h-screen">  
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between mt-6 md:mt-8 gap-4 md:gap-0">
      <p class="hidden md:block text-4xl font-bold ml-2">Berdasarkan Kategori</p>
      
      <div class="flex w-full md:w-auto">
        <UiCategoryFilter v-model="categoryParams" class="w-full md:w-auto" />
      </div>
    </div>

    <div class="flex md:hidden flex-col gap-4 mt-6 mb-2">
      <div class="flex items-end justify-between w-full">
        <h2 class="font-bold text-lg text-black">Berdasarkan Kategori</h2>
