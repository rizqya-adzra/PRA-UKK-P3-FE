...
<template>
  <div class="mt-24 px-4 w-full">
    
    <div class="relative bg-white rounded-4xl pt-20 pb-12 px-8 text-center w-full">
      
      <div class="absolute -top-28 left-1/2 transform -translate-x-1/2 w-44 h-44 bg-[#D9D9D9] rounded-full border-8 border-[#F6F6F6] z-10 overflow-hidden flex items-center justify-center">
      ...
      <a :href="user?.email ? `mailto:${user.email}` : undefined" class="text-sm text-gray-600 underline mt-1 inline-block hover:text-blue-600 transition-colors">
        {{ user?.email || '-' }}
      </a>
      ...
      <svg class="w-full text-gray-300 my-10" height="2" xmlns="http://www.w3.org/2000/svg">
        <line x1="0" y1="1" x2="100%" y2="1" stroke="currentColor" stroke-width="2" stroke-dasharray="16 20" />
      </svg>

      <div class="grid grid-cols-3 gap-4 text-center">
        <div>
          <p class="text-4xl md:text-5xl font-black text-black">{{ stats?.data.selesai || 0 }}</p>
          <p class="text-xs md:text-sm font-bold text-black mt-2 leading-tight">Aspirasi yang<br>disampaikan</p>
        </div>
        <div>
          <p class="text-4xl md:text-5xl font-black text-black">{{ stats?.data.proses || 0 }}</p>
          <p class="text-xs md:text-sm font-bold text-black mt-2 leading-tight">Sudah<br>terlaksanakan</p>
        </div>
        <div>
          <p class="text-4xl md:text-5xl font-black text-black">{{ stats?.data.menunggu || 0 }}</p>
          <p class="text-xs md:text-sm font-bold text-black mt-2 leading-tight">Masih dalam<br>proses</p>
        </div>
      </div>

    </div> <div class="flex items-center justify-center gap-6 mt-8 mb-12">
      ...
      <div class="flex items-center gap-4">
        ...
        <div class="flex-1">
          ...
          <label 
            ...
            class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md font-medium text-gray-700 bg-white hover:bg-gray-50 cursor-pointer"
          >
